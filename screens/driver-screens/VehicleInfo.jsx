    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.cardSection}>
          <Text style={styles.cardTitle}>Certificate of vehicle registeration (front side)</Text>
          <Image 
        ...
        <View style={styles.cardSection}>
          <Text style={styles.cardTitle}>Certificate of vehicle registeration (back side)</Text>
          <Image 
        ...
        <View style={styles.inputSection}>
          <Text style={styles.inputLabel}>Vehicle Productio Year (optional)</Text>
          <TextInput 
            style={styles.input} 
